...
describe("formatDate", () => {
  ...
  const setTestTime = () => {
    ...
    // New York local time: 24 Aug 2026, 21:00 EDT
    const now = new Date("2026-08-24T21:00:00-04:00");
  ...
  it("returns DD-MM-YY for more than one year ago", () => {
    ...
    const date = new Date("2025-07-15T12:00:00-04:00");
