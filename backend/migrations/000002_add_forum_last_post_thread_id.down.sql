...
-- =========================================================
-- RESTORE ORIGINAL FUNCTIONS (without last_post_thread_id)
-- =========================================================
...
DROP INDEX IF EXISTS idx_forums_last_post_thread_id;

ALTER TABLE forums
DROP CONSTRAINT IF EXISTS forums_last_post_thread_fk;

ALTER TABLE forums
DROP COLUMN IF EXISTS last_post_thread_id;
